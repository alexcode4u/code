...
<ItemDrawer>:
    ...
    on_release: self.parent.set_color_item(self, app.root.ids.manager)
            ...
            Screen:
                ...
                BoxLayout:
                    ...
                    MDToolbar:
                        id: toolbar
                        title: 'Settings' 
                        left_action_items: [['menu', lambda x: root.ids.nav_drawer.set_state()]]
                    ScrollView:
                        MDList:
                            ListItemWithCheckbox:
                                id: draw_mouse
...
class DrawerList(ThemableBehavior, MDList):
    def __init__(self, **kwargs):
        ...
        self.dir_ = {'Live translation': 'left', 'Settings': 'left'}

    def set_color_item(self, instance_item, sm):
        ...
        sm.transition.direction = self.dir_[instance_item.text]
        if instance_item.text == 'Live translation':
            sm.current = 'live_screen'
